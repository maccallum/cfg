...
(custom-set-variables
 ...
 '(font-latex-match-bold-command-keywords (quote (("cvitem" "{") ("years" "{"))))
 ...
 '(font-latex-match-italic-command-keywords (quote (("cvsubitem" "{"))))
 '(font-latex-match-warning-keywords (quote (("sk" ""))))
 ...
 '(package-selected-packages
   (quote
    (package-utils org org-drill lorem-ipsum julia-mode php-mode easy-jekyll poly-markdown realgud-lldb solarized-theme slime haskell-mode flatui-theme company color-theme-sanityinc-tomorrow auctex)))
